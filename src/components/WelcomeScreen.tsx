        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-10 px-4">
          ...
          >
             ...
             <div className="space-y-4">
                <h3 className="text-3xl font-black text-gray-900 leading-tight">المحادذة النصية <br /> <span className="text-gray-300 group-hover:text-[#3a9d47]/40 transition-colors duration-500">عبر البوت</span></h3>
